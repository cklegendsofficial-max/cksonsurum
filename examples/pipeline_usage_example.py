...
def main():
    ...
    def process_channel_pipeline(
        channel_name: str, timeframe: str = None, geo: str = None
    ):
        """
        ...
        print(
            f"Pipeline processing {channel_name} ({niche}): {len(topics)} topics available"
        )
        ...
        if topics:
            ...
            print("  - No topics available, using fallback")
